...
public class Request extends GetWorddic{ //getWorddic 상속받은 Request 클래스
	 ...
	 public void Request() { //질문 입력 받고 형태소 분석.
...
//         System.out.println(string);
          ...
          try { 
                ...
                List<MExpression> ret = ma.analyze(Hello);
...
//                            System.out.println(sp);
	...
	/*
	 * public static void main(String args[]) { Request rq = new Request();
	 * rq.Request(); }
	 */
